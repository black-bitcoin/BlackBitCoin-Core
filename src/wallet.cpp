...
// BlackBitcoin: total coins staked (non-spendable until maturity)
...
// BlackBitcoin: check 'spent' consistency between wallet and txindex
// BlackBitcoin: fix wallet spent state according to txindex
...
// BlackBitcoin: disable transaction (only for coinstake)
