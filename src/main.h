...
public:
    ...
    {
        // BlackBitcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // BlackBitcoin: get transaction coin age
...
public:
    ...
    // BlackBitcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // BlackBitcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // BlackBitcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // BlackBitcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // BlackBitcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // BlackBitcoin: block index flags
    enum  
    {
