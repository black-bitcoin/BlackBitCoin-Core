...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"light blue\">" + qVolume + " BlackBitcoin" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " BlackBitcoin" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " BlackBitcoin");
    }
