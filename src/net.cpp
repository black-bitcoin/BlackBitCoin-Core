...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("BlackBitcoin-ext-ip");
...
void ThreadTorNet(void* parg)
{
    ...
    RenameThread("BlackBitcoin-tornet");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("BlackBitcoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BlackBitCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("BlackBitcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("BlackBitcoin-adrdump");
...
{
    // Make this thread recognisable as the connection opening thread
    RenameThread("BlackBitcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("BlackBitcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BlackBitCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("BlackBitcoin-start");
